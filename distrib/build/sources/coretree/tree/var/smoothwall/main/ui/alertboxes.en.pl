...
'graphs.cgi' 		=> 'Statistical graphs based upon traffic usage across your SmoothWall\'s network interfaces.',
...
'time.cgi' 		=> 'Change timezone, manually set the time and date, and configure time syncronisation.',
