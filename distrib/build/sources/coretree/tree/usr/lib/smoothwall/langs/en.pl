...
'apc invalid nis port' => 'Invalid master server name/IP or port',
...
'apc invalid ups ip' => 'Invalid master UPS IP address',
...
'Email Alert Configurationc' => 'Email Alert Configuration:',
