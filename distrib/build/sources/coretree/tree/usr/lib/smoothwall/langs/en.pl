...
'Always' => 'Always',
'Annoy Message Period (Sec)' => 'Annoy Message Period (Sec)',
'Append' => 'Append',
'Cable' => 'Cable',
'Deny Shell Login when on battery' => 'Deny Shell Login when on battery',
'Disables' => 'Disables',
'Event Alert Emails' => 'Event Alert Emails',
'Full Operations Mode' => 'Full Operations Mode',
'Leave blank for default' => 'Leave blank for default',
'Mail Server' => 'Mail Server',
'Master NIS or UPS IP Address' => 'Master NIS or UPS IP Address',
'Minutes' => 'Minutes',
'NIS Listening Port' => 'NIS Listening Port',
'Never' => 'Never',
'Operation Mode' => 'Operation Mode',
'Operational mode (DO NOT select Full Operations Mode until you know that your configuration is OK)' => 'Operational mode (DO NOT select Full Operations Mode until you know that your configuration is OK)',
'Percent' => 'Percent',
'SMS Email Address' => 'SMS Email Address',
'Send Alerts From' => 'Send Alerts From',
'Send Alerts To' => 'Send Alerts To',
'Shutdown after time On Battery (Sec)' => 'Shutdown after time On Battery (Sec)',
'Shutdown when battery capacity remains' => 'Shutdown when battery capacity remains',
'Shutdown when battery runtime remains (Mins)' => 'Shutdown when battery runtime remains (Mins)',
'Standalone UPS' => 'Standalone UPS',
'Testing Mode' => 'Testing Mode',
'UPS Authentication Phrase' => 'UPS Authentication Phrase',
'UPS Configuration Information' => 'UPS Configuration Information',
'UPS Killpower on Shutdown' => 'UPS Killpower on Shutdown',
'UPS Name (Max 8 Char)' => 'UPS Name (Max 8 Char)',
'UPS On Battery Configuration' => 'UPS On Battery Configuration',
'UPS Polling Interval (Sec)' => 'UPS Polling Interval (Sec)',
'UPS Serial Port' => 'UPS Serial Port',
'UPS Type' => 'UPS Type',
'UPS User name' => 'UPS User name',
'Wait before responding to On Battery alert (Sec)' => 'Wait before responding to On Battery alert (Sec)',
'if not default' => 'if not default',
'port' => 'port',
'save&restart' => 'Save & Restart',
'shutdown smoothwall in response to a power failure' => 'shutdown smoothwall in response to a power failure',
'ssapcupsd' => 'ups',
